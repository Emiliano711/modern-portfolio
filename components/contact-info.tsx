    ...
    <section id="contact" className="py-24 px-4 sm:px-6 bg-background overflow-hidden">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="text-center p-6 sm:p-8 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-all duration-300 animate-fade-in-up" style={{ animationDelay: "0ms" }}>
          ...
          <div className="text-center p-6 sm:p-8 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-all duration-300 animate-fade-in-up" style={{ animationDelay: "100ms" }}>
            <div className="p-4 bg-primary/10 rounded-full w-fit mx-auto mb-6">
          ...
          <div className="text-center p-6 sm:p-8 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-all duration-300 sm:col-span-2 lg:col-span-1 animate-fade-in-up" style={{ animationDelay: "200ms" }}>
            <div className="p-4 bg-primary/10 rounded-full w-fit mx-auto mb-6">
